...
Die folgenden Aktionen und Konfigurationen werden in KVM-Workloads in NetApp Backup and Recovery nicht unterstützt:
...
Beachten Sie Folgendes bei der Verwendung von KVM-Workloads mit NetApp Backup and Recovery.
