...
** Wenn Sie lokale Kopien von Snapshots auf dem SnapMirror Zielvolume erstellen (unabhängig von den SnapMirror Labels), werden diese Snapshots nicht als Backups in die Cloud verschoben. Eine Snapshot-Richtlinie mit den gewünschten Labels muss auf dem Quell-DP-Volume erstellt werden, damit NetApp Backup and Recovery diese sichern kann.
