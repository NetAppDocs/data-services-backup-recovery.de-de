...
[role="lead"]
In NetApp Backup und Recovery können Sie Volumendaten Ihrer primären ONTAP-Systeme vor Ort auf ein sekundäres Speichersystem und in den StorageGRID Objektspeicher sichern. Auf dieser Seite lässt sich die Umgebung vorbereiten und die Backups aktivieren.
...
+
Die neue Version von NetApp Backup und Recovery, die neben der Erstellung von Backups auf Objektspeicher auch die Möglichkeit bietet, Snapshots und replizierte Volumes zu planen und zu erstellen, erfordert, dass Version 3.9.31 oder höher des Console Agent verwendet wird. NetApp empfiehlt, diese neueste Version zur Verwaltung aller Backups zu nutzen.
...
Weitere Informationen zu DataLock und den Anforderungen an den Ransomware-Schutz für StorageGRID finden Sie unter link:prev-ontap-policy-object-options.html["Optionen für die Backup-to-Object-Richtlinie"].

Unterstützte StorageGRID Versionen:: StorageGRID 10.3 und höher wird unterstützt.
+
--
Um DataLock & Ransomware-Schutz für Ihre Backups nutzen zu können, müssen Ihre StorageGRID-Systeme mindestens Version 11.6.0.3 oder höher ausführen.
...
Für die Nutzung des Archivspeichers ist ein IP-Zugriff auf den Administratorknoten erforderlich.
...
+
Wenn Ihr Cluster ONTAP 9.11.1 oder höher verwendet, besteht die Möglichkeit, Ihre Backups vor Löschung und Ransomware-Angriffen zu schützen, indem _DataLock and Ransomware protection_ konfiguriert wird. _DataLock_ schützt Ihre Backup-Dateien davor, geändert oder gelöscht zu werden, und _ransomware protection_ scannt Ihre Backup-Dateien, um Hinweise auf einen Ransomware-Angriff in Ihren Backup-Dateien zu erkennen.
