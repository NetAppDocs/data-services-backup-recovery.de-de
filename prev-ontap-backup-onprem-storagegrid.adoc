...
Weitere Informationen zu den Anforderungen an Datalock und Ransomware-Schutz für StorageGRID finden Sie unter link:prev-ontap-policy-object-options.html["Optionen für die Backup-to-Object-Richtlinie"].
...
+
Wenn Ihr Cluster ONTAP 9.11.1 oder höher verwendet, können Sie Ihre Backups vor Löschung und Ransomware-Angriffen schützen, indem Sie _DataLock und Ransomware-Schutz_ konfigurieren. _DataLock_ schützt Ihre Backup-Dateien davor, geändert oder gelöscht zu werden, und _Ransomware-Schutz_ scannt Ihre Backup-Dateien, um Hinweise auf einen Ransomware-Angriff in Ihren Backup-Dateien zu finden.
