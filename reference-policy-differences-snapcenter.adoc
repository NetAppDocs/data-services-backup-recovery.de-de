...
*Beispiel*: Wenn Sie über eine stündliche SnapCenter -Richtlinie mit einem Wiederholungsintervall alle 5 Stunden ab 1:00 Uhr verfügen, legt NetApp Backup and Recovery (nach der Migration) den Zeitplan auf täglich mit 5-Stunden-Intervallen um 1:00 Uhr, 6:00 Uhr, 11:00 Uhr, 16:00 Uhr und 21:00 Uhr fest.  Einige Stunden werden übersprungen. Nach 21:00 Uhr sollte es 2:00 Uhr sein, um die Wiederholung alle 5 Stunden durchzuführen, aber es wird immer 1:00 Uhr sein.
