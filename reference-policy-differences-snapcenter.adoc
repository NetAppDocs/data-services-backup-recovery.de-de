...
---
= Richtlinienunterschiede zwischen SnapCenter und NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Diese Referenz bietet einen Überblick über die Richtlinienunterschiede zwischen SnapCenter und NetApp Backup and Recovery, die sich auf importierte Ressourcen und Richtlinien auswirken können.
...
NetApp Backup and Recovery verwendet die folgenden Zeitplanebenen, die sich geringfügig unterscheiden:
...
* Wenn der SnapCenter-Zeitplan auf mehr als 7 Tage eingestellt ist, setzt NetApp Backup and Recovery den Zeitplan auf monatlich. Einige Snapshots werden im Laufe des Monats übersprungen.
+
...
*Beispiel*: Wenn Sie eine SnapCenter stündliche Richtlinie mit einem Wiederholungsintervall alle 5 Stunden ab 1:00 Uhr haben, stellt NetApp Backup and Recovery (nach der Migration) den Zeitplan auf täglich mit 5-Stunden-Intervallen um 1:00 Uhr, 6:00 Uhr, 11:00 Uhr, 16:00 Uhr und 21:00 Uhr ein. Einige Stunden werden übersprungen – nach 21:00 Uhr sollte es um 2:00 Uhr weitergehen, um alle 5 Stunden zu wiederholen, tatsächlich ist es aber immer 1:00 Uhr.
