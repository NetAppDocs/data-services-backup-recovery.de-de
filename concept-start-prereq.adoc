...
* Für die Nutzung von mehr als 6 Buckets pro System über verschiedene Cloud-Anbieter hinweg ist ONTAP 9.19.1 oder höher erforderlich (bis zu 100 Buckets werden unterstützt).
