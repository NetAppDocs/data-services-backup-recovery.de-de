...
* ASP.NET Core Runtime 8.0.23 Hosting Bundle (und alle nachfolgenden 8.0.x Patches)
* PowerShell 7.4.13
...
* ONTAP 9.13.1 oder höher
* Amazon FSx for NetApp ONTAP-Speichersysteme mit Version 9.13.1 oder höher
* SAN-Speicher (Vorschau) (unterstützt für Backups und Wiederherstellung am ursprünglichen Speicherort vom primären und sekundären Speicher)
