...
* Wenn Sie eine Workload aus einer Sicherungsdatei wiederherstellen, erstellt NetApp Backup and Recovery mithilfe der Daten aus der Sicherung eine _neue_ Ressource.
...
. Fahren Sie auf der Seite „Wiederherstellungsoptionen“ fort und wählen Sie „Zu einem bestimmten Zeitpunkt wiederherstellen“ aus.
. Wählen Sie *Weiter*.
