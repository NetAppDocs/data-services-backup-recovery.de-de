...
---
= Optionen für die Sicherung in Objektspeicher in NetApp Backup and Recovery verwalten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Schritte
. Wählen Sie auf der Registerkarte *Volumes* die Option *Backup-Einstellungen* aus.
. Klicken Sie auf der Seite „Sicherungseinstellungen“ auf image:icon-actions-horizontal.gif["Symbol „Mehr“"] für das System und wählen Sie *Erweiterte Einstellungen konfigurieren > Systemeinstellungen*.
...
Weitere Informationen zu Datalock und den Ransomware-Schutzoptionen finden Sie unter link:prev-ontap-policy-object-options.html["Optionen für Datalock und Ransomware-Schutz"].
...
.Schritte
. Wählen Sie auf der Registerkarte *Volumes* die Option *Backup-Einstellungen* aus.
. Klicken Sie auf der Seite „Sicherungseinstellungen“ auf image:icon-actions-horizontal.gif["Symbol „Mehr“"] für das System und wählen Sie *Erweiterte Einstellungen konfigurieren > Anbietereinstellungen*.
