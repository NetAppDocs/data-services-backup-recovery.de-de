...
* Erstellen Sie Schutzgruppen, um die Backup- und Recovery-Vorgänge für eine Gruppe von Ressourcen zu verwalten. Siehe link:br-use-hyperv-protection-groups.html["Hyper-V-Schutzgruppen in NetApp Backup and Recovery erstellen und verwalten"] für weitere Informationen.
