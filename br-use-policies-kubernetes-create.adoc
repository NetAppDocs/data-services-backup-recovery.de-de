...
[role="lead"]
NetApp Backup and Recovery ermöglicht die Erstellung von Kubernetes-Backup-Richtlinien, die die Backup-Häufigkeit, den Zeitplan und die Aufbewahrung steuern.
...
Backup and Recovery Superadministrator oder Backup and Recovery Backup-Administrator. Wenn Daten geschützt werden, die auf einem Cloud Volumes ONTAP Cluster gespeichert sind, ist zusätzlich die Cloud Volumes ONTAP Admin-Rolle erforderlich  https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Erfahren Sie mehr über die Zugriffsrollen der NetApp Console für alle Dienste"^].
