...
---
= Sichern Sie Cloud Volumes ONTAP Daten auf S3-kompatiblem Speicher mit NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Führen Sie einige Schritte in NetApp Backup and Recovery durch, um mit der Sicherung von Volumendaten aus Ihren Cloud Volumes ONTAP Systemen in S3 zu beginnen.
...
Erforderliche Informationen zur Verwendung von kundenverwalteten Schlüsseln zur Datenverschlüsselung:: Im Aktivierungsassistenten können Sie anstelle der standardmäßigen S3-Verschlüsselungsschlüssel Ihre eigenen, kundenspezifisch verwalteten Schlüssel für die Datenverschlüsselung auswählen. In diesem Fall müssen die verwalteten Verschlüsselungsschlüssel bereits eingerichtet sein https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-setting-up-kms.html["Erfahren Sie, wie Sie Ihre eigenen Schlüssel verwenden"^].
...
* Getestet und validiert mit Wasabi Object Storage, zudem wurden erfolgreiche Implementierungen mit MinIO, IBM Cloud Object Storage und Apple Object Store von Kunden berichtet.
...
Erforderliche AWS Cloud Volumes ONTAP Berechtigungen:: Wenn auf Ihrem Cloud Volumes ONTAP-System die ONTAP-Softwareversion 9.12.1 oder höher ausgeführt wird, muss die IAM-Rolle, die diesem System Berechtigungen bereitstellt, einen neuen Satz von S3-kompatiblen Berechtigungen speziell für NetApp Backup and Recovery aus der neuesten  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-iam-roles.html["Cloud Volumes ONTAP -Richtlinie"^] enthalten.
+
--
...
+
Wenn das S3-kompatible Ziel für Ihre Backups als Cluster auf der Seite *Systeme* vorhanden ist, können Sie den Cluster auf das S3-kompatible System ziehen, um den Einrichtungsassistenten zu starten.
