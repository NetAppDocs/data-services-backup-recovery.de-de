...
[role="lead"]
Mit der Such- und Wiederherstellungsfunktion können Sie Volumes, Ordner oder Dateien aus ONTAP Backup-Dateien wiederherstellen. Die Such- und Wiederherstellungsfunktion ermöglicht die Suche in allen Backups (einschließlich lokaler Snapshots, replizierter Volumes und Objektspeicher), ohne dass genaue System-, Volume- oder Dateinamen erforderlich sind.
