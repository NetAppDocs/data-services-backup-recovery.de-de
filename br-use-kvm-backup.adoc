...
* Erstellen Sie Schutzgruppen, um die Backup- und Recovery-Vorgänge für eine Gruppe von Ressourcen zu verwalten. Siehe link:br-use-kvm-protection-groups.html["KVM-Schutzgruppen in NetApp Backup and Recovery verwalten"] für weitere Informationen.
