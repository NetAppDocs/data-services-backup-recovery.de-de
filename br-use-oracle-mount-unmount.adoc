...
[role="lead"]
Einen Oracle Database-Wiederherstellungspunkt einbinden, wenn Zugriff auf die Datenbank in einem kontrollierten Zustand für Wiederherstellungsvorgänge erforderlich ist. Wenn die automatische Katalogisierung deaktiviert ist, kann die Katalogisierung der Metadaten des Wiederherstellungspunkts manuell im RMAN recovery catalog erfolgen.
...
== Einen Wiederherstellungspunkt einer Oracle Datenbank katalogisieren
