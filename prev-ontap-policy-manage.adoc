...
[role="lead"]
In NetApp Backup und Recovery können die Standardsicherungsrichtlinien verwendet oder benutzerdefinierte Richtlinien für Ihre ONTAP Volumes erstellt werden. Richtlinien steuern Sicherungshäufigkeit, Sicherungszeitpunkt und Aufbewahrungsdauer.
...
Wenn Sie den Aktivierungsassistenten verwenden, um den Backup und Recovery Service für Ihre Volumes zu aktivieren, können Sie aus den Standardrichtlinien und allen anderen bereits im System vorhandenen Richtlinien (Cloud Volumes ONTAP oder On-Premises ONTAP System) auswählen. Wenn eine andere Richtlinie als die vorhandenen verwendet werden soll, kann diese vor oder während der Nutzung des Aktivierungsassistenten erstellt werden.
...
NetApp Backup and Recovery bietet drei Arten von Backups von ONTAP Daten: Snapshots, Replikationen und Backups in den Objektspeicher. Die zugehörigen Richtlinien befinden sich je nach verwendeter Architektur und Art des Backups an unterschiedlichen Orten:
...
. Auf der Seite „Richtlinienverwaltung“ *Richtlinie erstellen* > *Snapshot-Richtlinie erstellen* auswählen.
...
.Schritte
. Auf der Seite „Richtlinienverwaltung“ *Richtlinie erstellen* > *Replikationsrichtlinie erstellen* auswählen.
...
.Schritte
. Auf der Seite „Richtlinienverwaltung“ *Richtlinie erstellen* > *Sicherungsrichtlinie erstellen* auswählen.
. Geben Sie im Abschnitt „Richtliniendetails“ den Richtliniennamen an.
. Geben Sie die SnapMirror -Beschriftungen (maximal 5) an, die die Aufbewahrungsdauer für jede Beschriftung angeben.
