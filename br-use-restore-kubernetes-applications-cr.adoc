...
---
= Kubernetes-Anwendungen mit NetApp Backup and Recovery mithilfe einer benutzerdefinierten Ressource wiederherstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Sie können die Wiederherstellungsvorgänge mithilfe erweiterter Einstellungen anpassen. Weitere Informationen sind unter link:br-use-kubernetes-advanced-restore-settings.html["Erweiterte Wiederherstellungseinstellungen für Kubernetes in NetApp Backup and Recovery"] zu finden.
