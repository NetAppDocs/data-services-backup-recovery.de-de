...
*Erforderliche NetApp Console-Rolle* Beide der folgenden Punkte werden benötigt:

* *Organisationsadministrator*
* Entweder *Backup and Recovery super admin* oder *Backup and Recovery backup admin*
