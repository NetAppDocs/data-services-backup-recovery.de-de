...
* *VMware-Workloads (mit neuer Benutzeroberfläche ohne SnapCenter Plug-in für VMware vSphere)*:
+
** Schützen Sie Ihre VMware-VMs und Datenspeicher mit NetApp Backup and Recovery.
** Sichern Sie VMware-Workloads auf Amazon Web Services S3 oder StorageGRID.
...
* Microsoft Azure Blob (nicht verfügbar für VMware workloads)
* StorageGRID
* ONTAP S3 (nicht verfügbar für VMware-Workloads)
