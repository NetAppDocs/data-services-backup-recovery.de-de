...
.. Geben Sie im Abschnitt *Zieleinstellungen* die folgenden Informationen ein:
+
...
.. Im Abschnitt *Zielspeicher* (nur sichtbar beim Wiederherstellen aus Objektspeicher):
+
...
.. Im Abschnitt *Vorbereitende Wiederherstellungsoptionen* sollten Sie folgende Optionen in Betracht ziehen:
+
