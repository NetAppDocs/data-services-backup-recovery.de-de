...
* Wenn Sie Backup and Recovery mit NetApp Console verwenden, können Sie eine Pay-as-you-go (PAYGO) Lizenz abonnieren oder eine Bring-your-own-license (BYOL) Lizenz erwerben.
...
Lizenzierung für NetApp Backup and Recovery einrichten.
...
=== Ein Jahresvertrag mit Marketplace- oder BYOL-Lizenzen kann verwendet werden.
...
== Lizenzierung für die lokale Bereitstellung von NetApp Backup and Recovery einrichten

Lizenzierung für die lokale Version der NetApp Console einrichten.
...
Die lokale NetApp Console-Bereitstellung wird zur Verwaltung von BYOL-Lizenzen verwendet. Neue Lizenzen können hinzugefügt, bestehende Lizenzen aktualisiert und der Lizenzstatus in der Console angezeigt werden.
