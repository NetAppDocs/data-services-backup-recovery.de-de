...
[role="lead"]
Je nachdem, ob Sie NetApp Console oder NetApp Console (lokale Bereitstellung) verwenden, kann NetApp Backup and Recovery lizenziert werden, indem entweder ein nutzungsbasiertes (PAYGO) oder ein jährliches Marketplace-Abonnement für *NetApp Intelligent Services* von Ihrem Cloud-Anbieter erworben wird oder eine eigene Lizenz (BYOL) von NetApp gekauft wird. Eine gültige Lizenz ist erforderlich, um NetApp Backup and Recovery auf einem System zu aktivieren, um Backups Ihrer Produktionsdaten zu erstellen und um Backup-Daten auf einem Produktionssystem wiederherzustellen.
...
* Eine Direktlizenz, auch bekannt als Bring-Your-Own-License (BYOL), kann von NetApp erworben werden. Diese Option gilt sowohl für NetApp Console als auch für die lokale Console-Bereitstellung.
...
Die NetApp Console oder die Console lokale Bereitstellung wird zur Verwaltung von BYOL-Lizenzen verwendet. Neue Lizenzen können hinzugefügt, bestehende Lizenzen aktualisiert und der Lizenzstatus in der Console angezeigt werden.
