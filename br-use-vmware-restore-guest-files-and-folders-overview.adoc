...
* Port 443 (HTTPS) auf dem VMware ESXi Server muss für die bidirektionale Kommunikation geöffnet sein.
* VMware Tools muss auf dem Gastbetriebssystem installiert und ausgeführt werden.
+
