...
. Prüfen Sie die Eignung der Volumes. Das System prüft, ob die Volumes für die Resynchronisierung geeignet sind. Wenn ein Volume nicht geeignet ist, bedeutet dies, dass die gemeinsamen Snapshot-Kriterien nicht erfüllt wurden.
+
