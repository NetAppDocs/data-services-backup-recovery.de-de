...
+
Wenn Sie sich zum ersten Mal bei NetApp Backup and Recovery anmelden und bereits ein System in der Console vorhanden ist, aber keine Ressourcen erkannt wurden, erscheint die Seite „Willkommen beim neuen NetApp Backup and Recovery“ mit der Option *Ressourcen erkennen*.
