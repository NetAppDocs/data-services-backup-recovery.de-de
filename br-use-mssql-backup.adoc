...
*Erforderliche NetApp Console-Rolle*: Backup and Recovery Super Admin oder Backup and Recovery Backup Admin Rolle. Für den Schutz von Daten, die auf einem Cloud Volumes ONTAP Cluster gespeichert sind, ist zusätzlich die Cloud Volumes ONTAP Admin Rolle erforderlich. Informationen dazu unter link:reference-roles.html["Backup und Recovery Rollen und Berechtigungen"]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Erfahren Sie mehr über die Zugriffsrollen der NetApp Console für alle Dienste"^].
...
. Wählen Sie eine Arbeitslast aus, um die Schutzdetails anzuzeigen.
. Wählen Sie das Symbol Aktionenimage:../media/icon-action.png["Aktionsoption"] > *Details anzeigen*.
. Die Registerkarte *Schutzgruppen*, *Verfügbarkeitsgruppen*, *Instanzen* oder *Datenbanken* auswählen.
