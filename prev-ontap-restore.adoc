...
* Sie können einen *Ordner* aus replizierten oder Objektspeicher-Snapshots auf ein Volume im ursprünglichen System, auf ein Volume in einem anderen System mit demselben Cloud-Konto oder auf ein Volume in einem lokalen ONTAP System wiederherstellen. Die Wiederherstellung von Ordnern aus lokalen Snapshots wird nicht unterstützt.
