...
* <<Anmeldeinformationen für Hostressourcen hinzufügen>> für alle Windows-, Microsoft SQL Server-, Oracle Database- oder Linux-Hosts, mit denen sich NetApp Backup and Recovery authentifizieren muss. Dies umfasst auch die Anmeldeinformationen des Gastbetriebssystems, die beim Wiederherstellen von Dateien oder Ordnern verwendet werden.
...
Erstellen Sie Vorlagen für Ressourcentransformationen, um häufige Transformationen zu speichern, die Sie an Ressourcen vornehmen, während Sie diese wiederherstellen.

.Schritte
. Wählen Sie im NetApp Backup and Recovery -Menü *Einstellungen* aus.
. Klicken Sie auf den Abwärtspfeil, um den Abschnitt *Resource modifer template* zu erweitern.
...
.. Optional können Sie eine Ressourcengruppe, Version, Namen eingeben.
