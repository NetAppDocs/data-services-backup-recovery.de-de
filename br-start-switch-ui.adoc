...
summary: Sie können zwischen den verschiedenen NetApp Backup- und Recovery-Workloads wechseln.  Einige Workloads verwenden eine andere Benutzeroberfläche. 
---
= Wechseln Sie zu anderen NetApp Backup- und Recovery-Workloads
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sie können zwischen den verschiedenen NetApp Backup- und Recovery-Workloads wechseln.
