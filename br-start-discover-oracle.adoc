...
.. Wählen Sie aus, ob NetApp Backup and Recovery das Plug-in automatisch installieren soll oder ob die automatische Plug-in-Installation übersprungen werden soll (wenn Sie *manuelle Installation verwenden* aktivieren, müssen Sie das Plug-in manuell auf dem Host installieren).
