...
[role="lead"]
Diese Informationen dienen zur Auswahl einer AWS S3-Archivierungsebene für NetApp Backup and Recovery Backups. Es besteht außerdem die Möglichkeit, Wiederherstellungskosten und Abrufzeiten für archivierte Backups zu überprüfen.
...
Wenn Backup-Dateien initial erstellt werden, werden sie im S3 _Standard_-Speicher gespeichert. Diese Ebene ist für die Speicherung von Daten optimiert, auf die selten zugegriffen wird, ermöglicht aber dennoch einen sofortigen Zugriff. Nach 30 Tagen wechseln die Backups in die Speicherklasse S3 _Standard-Infrequent Access_, um Kosten zu sparen.
