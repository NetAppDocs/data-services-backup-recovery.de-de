...
[role="lead"]
In NetApp Backup und Recovery können Sie Volumendaten Ihrer primären ONTAP-Systeme vor Ort in ONTAP S3 und optional auf ein sekundäres ONTAP System zur Replikation sichern. Auf dieser Seite lässt sich die Umgebung vorbereiten und die Backups aktivieren.
...
. *Lokaler Snapshot*: Es kann eine vorhandene Snapshot-Richtlinie ausgewählt oder eine neue erstellt werden.
+
